...
const photoGallery = {
    ...
    photos: [
        ...
        { src: './media/4.jpeg', caption: 'Construire une relation fondée sur la confiance et le respect' },
        { src: './media/5.jpg', caption: 'Respecter le rythme du chien, pour révéler son potentiel' },
        { src: './media/6.jpg', caption: 'Socialisation entre chiens' },
        { src: './media/7.jpg', caption: 'Votre chien a du potentiel. Nous le révélons' },
        { src: './media/8.jpg', caption: 'Nos installations modernes' },
        { src: './media/9.jpg', caption: 'Chiens en pension - aire de jeu' },
        { src: './media/10.jpeg', caption: 'Professionnalisme canin au service de la protection' },
        { src: './media/11.jpg', caption: 'Nos installations modernes' },
        { src: './media/12.jpeg', caption: 'La discipline est notre terrain de jeu' },
        { src: './media/13.jpg', caption: 'Séance de dressage individuelle' },
        { src: './media/14.jpg', caption: 'Formation d\'obéissance de base' },
        { src: './media/15.jpeg', caption: 'Le humain guide, le chien répond ensemble, ils progressent' },
